import devicesSerivce from '../services/chirpstack'
...
const CreateChirp = ({setIntPick, devList, setDeviceList}) => {
                        ...
                        <div>
                            ...
                            <div className='input-container'>
                                ...
                                <div className='display-block'>
                                    <div className='input-item'>
                                    <div className='label-container'>
                                        <label htmlFor='dev_eui'><strong>Device EUI</strong> </label>
                                    </div>
                                    <div className='.iui-input-container'>
                                        <input type='text' name='dev_eui' value={formData['dev_eui']} onChange={hadnleChange}></input>
                                    </div>
                                    </div>
                                    </div>
                                    </div>
